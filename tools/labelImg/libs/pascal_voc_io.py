...
class PascalVocWriter:
    ...
    def addBndBox(self, xmin, ymin, xmax, ymax, name, pose, difficult, truncated):
...
class PascalVocReader:
    ...
    def __init__(self, filepath):
        # shapes type:
        # [labbel, [(x1,y1), (x2,y2), (x3,y3), (x4,y4)], color, color, difficult, truncated]
        self.shapes = []
    ...
    def addShape(self, label, bndbox, difficult, truncated):
    ...
    def parseXML(self):
        ...
        for object_iter in xmltree.findall('object'):
            ...
            self.addShape(label, bndbox, difficult, truncated)
        return True
